    ...
    var template = '\
        <ul>\
            ...
            <li class="listTreeLink">\
                ...
                checked="checked"\
                <% } %> value="<%= parent.key %>" /> <%= parent.title %><i class="icon-chevron-up icon-black" onclick="$(this).parent().trigger(\'click\')"></i></span>\
                ...
                <% } %>\
                    ...
                    <li onclick="$(this).children().children().trigger(\'click\')">\
                        ...
                        checked="checked"\
                        <% } %> value="<%= child.key %>" /> <%= child.title %></span>\
                    </li>\
                    <% }, ps); %>\
                </ul>\
            </li>\
